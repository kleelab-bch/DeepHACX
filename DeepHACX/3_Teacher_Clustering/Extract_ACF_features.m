...
save('Vel.mat', 'Vel_truncated', 'Exper_label_truncated', 'Cellname_truncated');
dist_matrix = Calculate_distance(Vel_truncated(:, 196:251));
save('dist_euclidean.mat', 'dist_matrix');