function [mean_pro, lower_pro, upper_pro] = draw_confidence_interval_time(data, name, event)
%draw data_.
%
%
...
confplot(-350:5:350, mean_pro, lower_pro, upper_pro,'Color',[1 0 0],'LineWidth',1);
