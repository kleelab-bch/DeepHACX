...
for iln = 1:nline
    hl(iln) = line(xl{iln}, yl{iln}, 'LineWidth', 3,'marker', marker{iln}, 'linestyle', lnsty{iln}, 'color', lncol{iln}, 'parent', hax);
    
end
xlabel('time (s)', 'FontSize', 16);
ylabel('Normalized Fluorescence', 'FontSize', 16);
%legend([hl(1), hl(2), hl(3)], 'Cluster 1', 'Cluster 2', 'Cluster 3');
%--------------------
% Assign output
%--------------------
