...
pathname = '../whole_protrusion_event/distance';

name_short = {'PAA_196_end', 'PAA_201_end','dminpoolv_short_normr_196_end', 'dminpoolv_short_normr_201_end', 'symbolic_feat_data_196_end', 'symbolic_feat_data_201_end'};
name_whole = {'PAA_196_end', 'PAA_201_end','dminpoolv_long_normr_196_end', 'dminpoolv_long_normr_201_end', 'symbolic_feat_data_196_end', 'symbolic_feat_data_201_end'};
...
%load the dataset
whole_protrusion_event = load(fullfile('../whole_protrusion_event', 'whole_protrusion_event.mat'));
whole_dminpoolv = whole_protrusion_event.dminpoolv;
whole_dminpool = whole_protrusion_event.dminpool;
whole_dminpoolc = whole_protrusion_event.dminpoolc;

% %load the dataset
% whole_protrusion_event = load(fullfile('../whole_protrusion_event', 'whole_protrution_event_v_I_c.mat'));
% whole_dminpoolv = whole_protrusion_event.dminpoolv;
% whole_dminpool = whole_protrusion_event.dminpool;
% whole_dminpoolc = whole_protrusion_event.dminpoolc;
...
for i = 1 : length(name_whole)
    for j = 1 : length(postfix)
        ...
        for cl_K = 3 : 5
           ...
           cl_name = [name_whole{i}, postfix{1,j}, num2str(K), 'cl_a.mat'];
