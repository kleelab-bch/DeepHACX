...
% pathname = '../short_samples/distance';
pathname = '../long_samples/distance';
name_whole = {'PAA_196_end', 'PAA_201_end','dminpoolv_short_normr_196_end', 'dminpoolv_short_normr_201_end', 'symbolic_feat_data_196_end', 'symbolic_feat_data_201_end'};
...
%load the dataset
whole_protrusion_event = load(fullfile('../long_samples', 'long_whole_protrusion_event.mat'));
whole_dminpoolv = whole_protrusion_event.long_dminpoolv;
whole_dminpool = whole_protrusion_event.long_dminpool;
whole_dminpoolc = whole_protrusion_event.long_dminpoolc;
